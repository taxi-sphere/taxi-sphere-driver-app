    ...
    <Screen edges={['bottom']}>
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <Section title="Карта">
          ...
          <AppText variant="caption" tone="muted" style={styles.sectionHint}>
            В заказе карта едет за машиной. Отодвиньте её пальцем — останется,
            как поставили, и вернётся к машине, когда поедете дальше. Кнопка со
            значком прицела возвращает сразу.
          </AppText>
        </Section>
