...
const dark: ThemeColors = {
  ...
  // Было #6b7789 — 3.27:1 на шторке заказа (`surfaceElevated`): ночью номер
  // подъезда, подпись цели и этапы были самым бледным текстом экрана
  // (1.5.65, MOB-082). #8b97a9 — 5.0:1 на шторке и 5.8:1 на карточках;
  // вторичный текст по-прежнему заметно светлее.
  textMuted: '#8b97a9',
  /**
