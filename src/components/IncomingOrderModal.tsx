 ...
 *   город снимается — на ширине 320 px однострочный адрес обрезался ровно на
 *   доме, то есть на том, ради чего водитель в него и смотрит. Снятие города
 *   переехало на сервер в v1.99.78.
 *
 *   ПОДЪЕЗДА ЗДЕСЬ НЕТ, и это намеренно: в момент предложения водитель решает
 *   «брать или нет» по адресу и цене, а подъезд нужен уже когда подъехал —
 *   там он и написан, на экране заказа. (Прежняя редакция этой шапки обещала
 *   чип с подъездом, которого в коде никогда не было.)
 *
