...
const createStyles = (t: Theme) =>
  StyleSheet.create({
     ...
     * ширины идёт подписям: «Ожидание» — самое длинное слово шкалы, а
     * шрифт мельче 12 в этом проекте запрещён (см. `text` в tokens.ts).
     * Отступ, если он нужен, задаёт родитель — он один знает, что стоит
     * рядом.
     */
