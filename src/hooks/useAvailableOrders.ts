...
export function useAvailableOrders(radiusKm?: number) {
  ...
  return {
    ...
    /**
     * Водитель сам не на линии — запрос выключен, и пустой список означает
     * НЕ «заказов нет», а «мы их не спрашивали». Экран обязан говорить
     * разное: «свободных заказов нет» и «вы не на линии» — это две разные
     * причины пустого экрана и два разных действия водителя (1.5.38).
     */
    isDriverOffline: !isActive,
  };
}
